                    ...
                    if char_region.area > 0:
                        ...
                        if char_region.area < 10 and c_minc < 43:
                            ...
                            with open('mycsv_character.csv', 'a', newline='') as f:
                                ...
                                writer = csv.DictWriter(f, fieldnames=field)
                                # writer.writeheader()
                                writer.writerow({'count': str(image_count) + "_" + str(image_num)+ "_" + str(word_image_num)})
                        else:
                            continue
...
CharacterExtractor().character_extractor(path=r"F:\Study MIT\Final Project\OCR\1.jpg")
